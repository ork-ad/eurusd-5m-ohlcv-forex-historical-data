...
- **Free evaluation sample** on GitHub (`5m`) · **13 timeframes** on [ork.ad](https://ork.ad/) · **1,818,060** `5m` rows in the full archive
- Built for **backtesting**, **algorithmic trading** and **quantitative finance** workflows
- **Weekly refresh** — [ork.ad](https://ork.ad/) every **Sunday**; GitHub `5m` sample updated in sync

> **Sample on GitHub** · `EURUSD_5m.csv` (37,401 rows, `2026-01-04` → `2026-07-03`). **Full archive on [ork.ad](https://ork.ad/)** — **1,818,060** `5m` rows (~96.72 MB), **13 timeframes** (``1m`, `3m`, `5m`, `15m`, `30m`, `1H`, `2H`, `4H`, `8H`, `12H`, `16H`, `1D`, `1W``), `2001-11-28` → `2026-07-03`.
...
| 5m rows | 37,401 | **1,818,060** |
| Size | 2.03 MB | ~96.72 MB |
...
| --- | --- | --- | --- | --- | --- |
| 2026-01-04T22:05:00Z | 1.17216 | 1.17216 | 1.17206 | 1.17208 | 28 |
| 2026-01-04T22:10:00Z | 1.17208 | 1.17217 | 1.17203 | 1.17217 | 38 |
| 2026-01-04T22:15:00Z | 1.17217 | 1.17217 | 1.1721 | 1.17215 | 32 |
| 2026-01-04T22:20:00Z | 1.17215 | 1.17216 | 1.17215 | 1.17216 | 20 |
| 2026-01-04T22:25:00Z | 1.17216 | 1.17216 | 1.17209 | 1.172 | 30 |
...
| --- | --- | --- | --- | --- | --- |
| time | open | high | low | close | volume |
| 2026-07-03T20:35:00Z | 1.14368 | 1.1437 | 1.14364 | 1.14365 | 51 |
| 2026-07-03T20:40:00Z | 1.14365 | 1.14373 | 1.14365 | 1.1437 | 95 |
| 2026-07-03T20:45:00Z | 1.1437 | 1.14374 | 1.14347 | 1.14367 | 335 |
| 2026-07-03T20:50:00Z | 1.14367 | 1.14373 | 1.14347 | 1.1437 | 186 |
...
The complete **EURUSD** archive on **[ork.ad](https://ork.ad/)** includes **13 OHLCV timeframes** (`1m`, `3m`, `5m`, `15m`, `30m`, `1H`, `2H`, `4H`, `8H`, `12H`, `16H`, `1D`, `1W`) — **1,818,060** rows at `5m`, plus all other timeframes in the same ZIP.

**[→ Get the full EURUSD dataset on ork.ad](https://ork.ad/)**

---
*GetData · EURUSD 5m OHLCV sample on GitHub · Full historical data on [ork.ad](https://ork.ad/) · 2026-07-06 UTC*